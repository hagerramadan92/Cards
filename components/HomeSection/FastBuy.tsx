...
export default function FastBuy({
  ...
  return (
    <>
      <div className="p-3 fast_buy w-full">
        <div className="flex items-center gap-1">
          <h1 className="lg:text-2xl text-xl font-bold text-pro-max mb-2">
            {t("fast_buy")}
          </h1>
          <Image
            src="/images/tap.svg"
        ...
        <div
          id="all_cate"
          className="flex flex-nowrap overflow-x-auto gap-2 scrollbar-light w-full"
        >
          {categories.map((item) => (
